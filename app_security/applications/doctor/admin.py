...
class CitaMedicaAdmin(admin.ModelAdmin):
    form = CitaMedica.get_admin_form()
    class Media:
        js = ('doctor/admin_horarios.js',)
    ...
    def render_change_form(self, request, context, *args, **kwargs):
        context['adminform'].form.fields['hora_cita'].widget = forms.HiddenInput()
        context['adminform'].form.fields['hora_cita'].label = mark_safe('<div id="id_hora_cita_radios"></div>')
